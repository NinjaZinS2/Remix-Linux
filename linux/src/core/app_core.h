...
enum : int {
    ...
    Z_SET_ON_FOLDER=795, Z_SET_ON_RECHECK=796, Z_PL_MODE=797, Z_ON_CLOSE=798, Z_ON_QBOX=799, Z_ON_SEARCH=800, Z_ON_ADDALL=801,
    // Separar/novidades: ficavam em 820..823 e batiam com Z_SETTINGS_STYLE_BASE (o botao virava "trocar estilo"). Movidos para o buraco livre 802..805.
    Z_SET_SEP=802, Z_SET_SEP_BUSCAR=803, Z_SET_STEMSCPU=804, Z_SET_NOVIDADES=805,
    Z_ON_SRC_BASE=810, Z_ON_TAB_BASE=814, Z_SET_CLI=817, Z_SET_CLI_BUSCAR=818, Z_ON_CFG=819,
    Z_SETTINGS_STYLE_BASE=820,   // +0 classico, +1 remix
...
// As zonas novas das Configuracoes nao podem cair na faixa do ESTILO (senao o botao troca o estilo).
static_assert(Z_SET_SEP<Z_SETTINGS_STYLE_BASE && Z_SET_SEP_BUSCAR<Z_SETTINGS_STYLE_BASE && Z_SET_STEMSCPU<Z_SETTINGS_STYLE_BASE
    && Z_SET_NOVIDADES<Z_SETTINGS_STYLE_BASE && Z_SET_CLI<Z_SETTINGS_STYLE_BASE && Z_SET_CLI_BUSCAR<Z_SETTINGS_STYLE_BASE
    && Z_ON_CFG<Z_SETTINGS_STYLE_BASE, "zona de Configuracoes caiu na faixa do ESTILO");
