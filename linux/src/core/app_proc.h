#pragma once
// Processos externos sem shell (a CLI de midia configurada, ffmpeg): argumentos em vetor, sem
// problema de aspas ou acentos. Linux: posix_spawn num grupo proprio (Kill mata
// tambem os filhos, ex.: o ffmpeg que a CLI chama). Windows: CreateProcessW sem
...
inline bool Proc::Start(const std::vector<std::wstring>& args, bool pipeOut, bool pipeErr, bool pipeIn) {
    ...
    // Job "mata junto": se o Remix fechar (ou cair), o a fonte externa e o ffmpeg nao fica rodando sozinho.
